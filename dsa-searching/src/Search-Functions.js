...
let searchFunctions = {
  arr: [
    ...
    32, 26, 2, 14, 33, 45, 72, 56, 44, 21, 88, 27, 68, 15, 62, 93, 98, 73, 28, 16,
    46, 87, 28, 65, 38, 67, 16, 85, 63, 23, 69, 64, 91, 9, 70, 81, 27, 97, 82, 6, 88,
    3, 7, 46, 13, 11, 64, 76, 31, 26, 38, 28, 13, 17, 69, 90, 1, 6, 7, 64, 43, 9,
  ...
  searchLinear: function (val) {
    ...
    results.found = "Integer was not found";
    return results;
  },
...
// export default class searchFunctions extends React.Component {
//   state = {
//     data: [89, 30, 25, 32, 72],
//     userInput: 0,
//     numSearch: 0,
...
//   searchSubmitBinary(event) {
//     event.preventDefault();
//     const data = this.state;
//     const input = this.state.userInput;
//     let start = start === undefined ? 0 : start;
//     let end = end === undefined ? data.length : end;
...
//     }
//     else if (item < input) {
//       return this.searchSubmitBinary(array, value, index + 1, end);
//     }
//     else if (item > input) {
//       return this.searchSubmitBinary(array, value, index - 1, end);
//     }
